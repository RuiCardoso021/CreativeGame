...
namespace CreativeGame
{
    public class NPC : AnimatedSprite
    {
        ...
        public NPC(Game1 game, World world, Vector2 position) : base("enemy", position, Enumerable.Range(0, 22).Select(n => game.Content.Load<Texture2D>($"Inimigo/Screenshot_{n + 1}")).ToArray())
        {
